  ...
  return (
    <div className="md:hidden">
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="left" className="h-screen w-72 p-0 bg-transparent border-none shadow-none overflow-hidden">
          <div className="h-full overflow-y-auto">
            <SidebarContent pathname={pathname} isCollapsed={false} onLinkClick={() => setOpen(false)} />
          </div>
        </SheetContent>
      </Sheet>
    </div>
...
function SidebarContent({
  ...
  return (
    <div className="h-full flex flex-col min-h-0 bg-white/10 backdrop-blur-xl border-r border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
        ...
        {!isCollapsed && (
          <div className="flex items-center space-x-3 mb-3">
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-slate-900 truncate">Burak Şirin</p>
